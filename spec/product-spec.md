...
**Mirror notice:** This file mirrors repository root **`SPEC.md`**. Private family context lives in **`SPEC.local.md`** (gitignored). When requirements change, update **`SPEC.md`** first, then keep this file in sync (or symlink—your choice).
